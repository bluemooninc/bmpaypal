...
class bmpaypal_AbstractFilterForm
{
	var $mSort = 0;
	var $mSortKeys = array();
	var $_mCriteria = null;
	...
	function bmpaypal_AbstractFilterForm(&$navi, &$handler)
	{
		$this->mNavi =& $navi;
		...
		$this->mNavi->mGetTotalItems->add(array(&$this, 'getTotalLocation'));
	}
	...
	function getTotalLocation(&$total)
	{
